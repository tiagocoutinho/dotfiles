...
alias gcfg='/usr/bin/git --git-dir=$DOTFILES --work-tree=$HOME'
alias gcfg-init='git init --bare $DOTFILES'
alias gcfg-config='gcfg config --local status.showUntrackedFiles no'
